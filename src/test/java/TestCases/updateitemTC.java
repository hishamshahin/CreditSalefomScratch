...
public class updateitemTC extends TestBase
{
	...
	public void Userupdateitem() throws InterruptedException
	{
		...
		Registerpageobj.clickupdateitemBTN1();
		Thread.sleep(7000);

		/*updateitempageobj.ItemTypeDllEdit("طرد");
		updateitempageobj.enterItemWeightEdit("2000");
		updateitempageobj.enterReferenceIdTxtEdit("10");
		updateitempageobj.enterNameReceptionEdit("hishammoahmed");*/
		
		JavascriptExecutor js1 = ((JavascriptExecutor) driver);
		js1.executeScript("window.scrollTo(0, 250)");
		Thread.sleep(4000);
		updateitempageobj.clicksaveEditBtn();
